      ...
      <div id="home" className="pt-20 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <p className="text-xl font-bold mb-4 text-blue-500">
            Software Developer | AI & ML | Full Stack Developer
            </p>
          <p className="text-base mb-6 text-gray-700 dark:text-gray-300 leading-relaxed">
            Fourth-year Computer Science student specializing in Artificial Intelligence and Machine Learning at VIT Vellore. Experienced in Full-Stack Development, Enterprise Automation, AI/ML, and Software Testing through internships and real-world projects. Passionate about building scalable software solutions using modern technologies.
          </p>
          <div className="flex gap-5 mb-6">
            ...
            <a href="https://drive.google.com/file/d/1Ahb2_kNXVmDMEJjjTepc2a0Jt7Qy4FLn/view?usp=drivesdk" target="_blank">
...
>
  ...
  <div className="bg-white/10 backdrop-blur-md border border-gray-300 dark:border-gray-700 rounded-xl p-4 text-center shadow-md hover:scale-105 transition">
  ...
  <div className="bg-white/10 backdrop-blur-md border border-gray-300 dark:border-gray-700 rounded-xl p-4 text-center shadow-md hover:scale-105 transition">
    <h3 className="text-3xl font-bold text-indigo-600">8.57</h3>
    <p className="text-sm text-gray-600 dark:text-gray-300">
      CGPA
    </p>
  </div>
  ...
  <div className="bg-white/10 backdrop-blur-md border border-gray-300 dark:border-gray-700 rounded-xl p-4 text-center shadow-md hover:scale-105 transition">
    <h3 className="text-3xl font-bold text-indigo-600">AI + Full Stack</h3>
    <p className="text-sm text-gray-600 dark:text-gray-300">
      Specialization
    </p>
  </div>
      ...
      <motion.div
        ...
        Software Developer Intern – IBS Software
        </h3>

        <p className="text-gray-700 dark:text-gray-400 text-sm">
        May 2026 – July 2026 • Bangalore
        </p>

        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 text-sm mt-2 space-y-1">

        <li>Developed enterprise automation solutions for the iFly Loyalty platform.</li>

        <li>Built Python tools for XML/Excel rule conversion, SQL validation and PostgreSQL deployment script generation.</li>

        <li>Designed an end-to-end Java automation framework integrating REST APIs, Selenium, PostgreSQL, ETL jobs, SSH validation and PDF invoice verification.</li>

        <li>Collaborated with QA and development teams to automate testing and deployment workflows.</li>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {[

          {
            ...
            desc:"Full-stack React & Firebase platform with Authentication, Cloud Firestore, role-based access, complaints, notices, resident management and real-time synchronization.",
           
            github: "https://github.com/siidakk/smart-society-management",
          },

            {
            title:"IngredAI",

            desc:"AI-powered ingredient recognition using ResNet18 and PyTorch with recipe generation using Ollama and Llama 3.",

            github: "https://github.com/siidakk/IngredAI-AI-Powered-Ingredient-Recognition-Recipe-Generation",

            },

            {
            title:"NIFTY 500 Financial Analyzer",

            desc:"Machine Learning stock prediction system using Random Forest, Pandas and NumPy with feature engineering, model training and deployment using Joblib.",

            github: "https://github.com/siidakk/NIFTY-500---Machine-Learning-Financial-Analyzer",
      ...
      >
        <div className="bg-white/10 backdrop-blur-md p-5 rounded-xl border border-gray-300 dark:border-gray-700 shadow-md">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-sm mt-2 leading-relaxed">
            ...
            5th Semester : 8.55<br />
            6th Semester : 8.40<br />
            <strong>Cumulative CGPA: 8.57</strong>
          </p>
        </div>
  ...
  <p>
    <span className="font-semibold text-black dark:text-white">Sidak Arora © 2026.</span>{' '}
